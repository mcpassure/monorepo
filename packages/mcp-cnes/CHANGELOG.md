...
- Aplica padrões Onda 1.5: monorepo turborepo + changesets, E2E spawn via stdio, schema-drift detection (workflow semanal), canary diário com gestão automática de issues, SAFE-MCP mapping detalhado com Lethal Trifecta declaration, SECURITY-INSIGHTS.yml (formato OpenSSF), OSSF Scorecard, README bilíngue PT/EN completo, CONTRIBUTING + SECURITY + CODE_OF_CONDUCT bilíngues. CPF masking privacy-first documentado.
