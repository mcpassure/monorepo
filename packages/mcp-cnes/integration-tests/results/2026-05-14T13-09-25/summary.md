...
| Q07 | porNome filtra por UF SC retorna HU UFSC | ✓ pass | 1ms |  |
...
| T13 | buscar_por_tipo: hospitais em SC retornam HU UFSC | ✓ pass | 1ms |  |
...
| F07 | Todas as 8 tools propagam modo cache_vazio quando dataset vazio | ✓ pass | 0ms |  |
