...
|----|------|--------|---------|---------|
| Q01 | porCodigo retorna HC FMUSP | ✓ pass | 1ms |  |
...
| Q09 | porNome respeita limit | ✓ pass | 1ms |  |
...
| Q40 | coordinates são números quando presentes | ✓ pass | 1ms |  |
...
| F02 | fallback/client.ts: buscarPorNomeFallback lança CacheVazioError | ✓ pass | 0ms |  |
| F03 | Repository: buscarPorCodigoCnes retorna mensagem clara quando dataset vazio | ✓ pass | 1ms |  |
| F04 | Repository: buscarPorNome retorna aviso de sync quando dataset vazio | ✓ pass | 0ms |  |
| F05 | Repository: listar_leitos retorna aviso específico de LT quando dataset vazio | ✓ pass | 1ms |  |
| F06 | Repository: listar_profissionais retorna aviso específico de PF quando dataset vazio | ✓ pass | 0ms |  |
...
| M03 | _meta presente em buscar_por_nome | ✓ pass | 1ms |  |
| M04 | _meta presente em buscar_por_municipio | ✓ pass | 0ms |  |
| M05 | _meta presente em listar_leitos | ✓ pass | 1ms |  |
