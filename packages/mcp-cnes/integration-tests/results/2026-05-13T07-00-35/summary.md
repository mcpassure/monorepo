...
| Q14 | porTipo hospitais em SP | ✓ pass | 1ms |  |
...
| ID | Nome | Status | Duração | Detalhe |
|----|------|--------|---------|---------|
| F01 | buscarPorCodigoCnes: HC FMUSP (2077485) via API | ✓ pass | 16ms |  |
| F02 | buscarPorCodigoCnes: CNES inexistente retorna null | ✓ pass | 22ms |  |
| F03 | buscarPorNomeFallback: 'hospital das clinicas' retorna resultados | ✓ pass | 10ms |  |
| F04 | buscarPorNomeFallback: todos resultados têm source=online_fallback | ✓ pass | 7ms |  |
| F05 | buscarPorNomeFallback: codigoCnes tem 7 dígitos | ✓ pass | 8ms |  |
| F06 | buscarPorNomeFallback com UF filtra resultados | ✓ pass | 9ms |  |
| F07 | diagnóstico: formato codUnidade correto (7 vs 13 dígitos) | ✓ pass | 14ms |  |
...
| FTP07 | converterDbcParaCsv: blast converte DBC para CSV | ✓ pass | 66ms |  |
| FTP08 | ingerirCsv: insere registros de ST SC no banco | ✓ pass | 9ms |  |
