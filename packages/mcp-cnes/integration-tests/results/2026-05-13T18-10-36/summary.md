...
| Q22 | equipamentosPorCnes retorna equipamentos do HC FMUSP | ✓ pass | 1ms |  |
...
| Q30 | profissionaisPorCnes campos obrigatórios preenchidos | ✓ pass | 1ms |  |
...
| T08 | buscar_por_nome: busca sem UF retorna resultados | ✓ pass | 0ms |  |
...
| T14 | buscar_por_tipo: tipo com município filtra corretamente | ✓ pass | 2ms |  |
| T15 | listar_profissionais: HC FMUSP tem profissionais | ✓ pass | 1ms |  |
| T16 | listar_profissionais: CPFs todos mascarados | ✓ pass | 0ms |  |
| T17 | listar_profissionais: CNES sem profissionais retorna total 0 | ✓ pass | 1ms |  |
...
| T26 | listar_servicos: HC FMUSP tem serviços especializados | ✓ pass | 1ms |  |
...
### t05-scenarios (2 passaram / 13 falharam / 15 total)

| ID | Nome | Status | Duração | Detalhe |
|----|------|--------|---------|---------|
| S01 | Médico busca o Hospital das Clínicas de SP pelo nome | ✗ fail | 0ms | TypeError: Cannot read properties of undefined (reading 'some') |
| S02 | Gestor verifica dados cadastrais do HC FMUSP | ✗ fail | 0ms | AssertionError: HC FMUSP deve ser encontrado |
| S03 | Regulador verifica capacidade UTI do HC FMUSP | ✗ fail | 1ms | TypeError: Cannot read properties of undefined (reading 'filter') |
| S04 | Pesquisador lista hospitais em São Paulo para estudo de rede | ✗ fail | 0ms | TypeError: Cannot read properties of undefined (reading 'some') |
| S05 | Cardiologista verifica equipamentos do InCor | ✗ fail | 0ms | TypeError: Cannot read properties of undefined (reading 'some') |
| S06 | Gestor em SC verifica hospitais de Florianópolis | ✗ fail | 1ms | TypeError: Cannot read properties of undefined (reading 'some') |
| S07 | Oncologista localiza centros de oncologia | ✗ fail | 0ms | TypeError: Cannot read properties of undefined (reading 'some') |
| S08 | Pesquisador verifica serviços de transplante disponíveis | ✗ fail | 0ms | TypeError: Cannot read properties of undefined (reading 'some') |
| S09 | Gestor RH verifica profissionais do HCPA com privacidade | ✗ fail | 0ms | TypeError: r.profissionais is not iterable |
| S10 | Sistema verifica CNES inválido sem crash | ✗ fail | 0ms | AssertionError: CNES inexistente deve retornar encontrado=false |
| S11 | Pesquisador mapeia rede assistencial de SP por tipo | ✓ pass | 0ms |  |
| S12 | Radioterapia: verificar equipamentos do INCA | ✗ fail | 0ms | TypeError: Cannot read properties of undefined (reading 'some') |
| S13 | Múltiplos hospitais em DF para comparação de leitos UTI | ✗ fail | 0ms | TypeError: Cannot read properties of undefined (reading 'length') |
| S14 | Busca por nome 'einstein' encontra hospital | ✗ fail | 0ms | AssertionError: busca deve completar sem erro |
...
| ID | Nome | Status | Duração | Detalhe |
|----|------|--------|---------|---------|
| M01 | _meta presente em buscar_por_codigo_cnes (encontrado) | ✓ pass | 1ms |  |
| M02 | _meta presente em buscar_por_codigo_cnes (não encontrado) | ✓ pass | 0ms |  |
...
| M06 | _meta presente em listar_equipamentos | ✓ pass | 0ms |  |
| M07 | _meta presente em listar_profissionais | ✓ pass | 1ms |  |
| M08 | _meta modo=cache_local quando dataset populado | ✓ pass | 2ms |  |
