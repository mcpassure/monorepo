...
| Q05 | porNome busca parcial case-insensitive | ✓ pass | 1ms |  |
...
| Q19 | leitosPorCnes leitos UTI têm qt_exist > 0 | ✓ pass | 1ms |  |
...
| Q28 | profissionaisPorCnes CPFs estão mascarados | ✓ pass | 1ms |  |
...
| Q39 | vinculoSus é booleano nos estabelecimentos | ✓ pass | 1ms |  |
...
| ID | Nome | Status | Duração | Detalhe |
|----|------|--------|---------|---------|
| T01 | buscar_por_codigo_cnes: HC FMUSP retorna encontrado=true | ✓ pass | 4ms |  |
...
| T05 | buscar_por_nome: 'clinicas' retorna resultados em SP | ✓ pass | 2ms |  |
...
| T14 | buscar_por_tipo: tipo com município filtra corretamente | ✓ pass | 3ms |  |
...
| M08 | _meta modo=cache_local quando dataset populado | ✓ pass | 3ms |  |
