...
| Q21 | leitosPorCnes CNES sem leitos retorna vazio | ✓ pass | 1ms |  |
...
| T27 | listar_servicos: INCA tem serviço de oncologia | ✓ pass | 2ms |  |
...
### t03-fallback (7 passaram / 0 falharam / 7 total)

| ID | Nome | Status | Duração | Detalhe |
|----|------|--------|---------|---------|
| F01 | buscarPorCodigoCnes: HC FMUSP (2077485) via API | ✓ pass | 15ms |  |
| F02 | buscarPorCodigoCnes: CNES inexistente retorna null | ✓ pass | 11ms |  |
| F03 | buscarPorNomeFallback: 'hospital das clinicas' retorna resultados | ✓ pass | 8ms |  |
| F04 | buscarPorNomeFallback: todos resultados têm source=online_fallback | ✓ pass | 8ms |  |
| F05 | buscarPorNomeFallback: codigoCnes tem 7 dígitos | ✓ pass | 8ms |  |
| F06 | buscarPorNomeFallback com UF filtra resultados | ✓ pass | 7ms |  |
| F07 | diagnóstico: formato codUnidade correto (7 vs 13 dígitos) | ✓ pass | 16ms |  |
...
| FTP07 | converterDbcParaCsv: blast converte DBC para CSV | ✓ pass | 72ms |  |
| FTP08 | ingerirCsv: insere registros de ST SC no banco | ✓ pass | 10ms |  |
