...
| T19 | listar_leitos: InCor tem UTI Coronariana | ✓ pass | 2ms |  |
...
| ID | Nome | Status | Duração | Detalhe |
|----|------|--------|---------|---------|
| F01 | buscarPorCodigoCnes: HC FMUSP (2077485) via API | ✓ pass | 13ms |  |
| F02 | buscarPorCodigoCnes: CNES inexistente retorna null | ✓ pass | 9ms |  |
| F03 | buscarPorNomeFallback: 'hospital das clinicas' retorna resultados | ✓ pass | 7ms |  |
| F04 | buscarPorNomeFallback: todos resultados têm source=online_fallback | ✓ pass | 10ms |  |
| F05 | buscarPorNomeFallback: codigoCnes tem 7 dígitos | ✓ pass | 7ms |  |
| F06 | buscarPorNomeFallback com UF filtra resultados | ✓ pass | 7ms |  |
| F07 | diagnóstico: formato codUnidade correto (7 vs 13 dígitos) | ✓ pass | 15ms |  |
...
| FTP05 | listarArquivos PF SP tem competência recente (após 2024) | ✓ pass | 1ms |  |
| FTP06 | downloadArquivo ST SC baixa arquivo DBC | ✓ pass | 1ms |  |
| FTP07 | converterDbcParaCsv: blast converte DBC para CSV | ✓ pass | 63ms |  |
