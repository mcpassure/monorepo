...
### t01-queries (38 passaram / 2 falharam / 40 total)
...
| Q32 | servicosPorCnes HC FMUSP tem serviço de oncologia | ✗ fail | 0ms | AssertionError: Expected array to contain a matching element |
| Q33 | servicosPorCnes INCA tem radioterapia | ✗ fail | 0ms | AssertionError: Expected array to contain a matching element |
...
### t02-tools (29 passaram / 1 falharam / 30 total)
...
| T27 | listar_servicos: INCA tem serviço de oncologia | ✗ fail | 0ms | AssertionError: Expected array to contain a matching element |
...
| S08 | Pesquisador verifica serviços de transplante disponíveis | ✗ fail | 1ms | AssertionError: HC FMUSP deve ter serviço de transplante |
